...
class DetectSign():
    def __init__(self):
        ...
        self.move1 = float(self.rospy.get_param("~move1", 0.5))
        self.turn2 = int(rospy.get_param("~turn2", 70))
        self.move2 = float(self.rospy.get_param("~move2", 0.59))
        # Optional
        self.turn3 = int(rospy.get_param("~turn3", 50))
        self.move3 = float(self.rospy.get_param("~move3", 0.1))

        # Lidar Param
        self.threshold_distance = float(self.rospy.get_param("~threshold_distance", 0.3))
        self.angle_scan = self.rospy.get_param("~angle_scan", 5)
    ...
    def cbConstruction(self):
        ...
        # Construction Process
            if self.is_obstacle_detected == True and self.avoid_obstacle_count == 0:
                ...
                self.task_complete.publish(String(data="Construction_Complete"))
